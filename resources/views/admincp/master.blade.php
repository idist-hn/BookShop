...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
  @include('admincp.panel.navbar')
  
  <div class="app-body">
    @include('admincp.panel.sidebar')
    <!-- Main content -->
    <main class="main">

      <!-- Breadcrumb -->
      @include('admincp.panel.breadcrumb')

      @yield('content')
      <!-- /.container-fluid -->
    </main>

    @include('admincp.panel.asidemenu')

  </div>

  @include('admincp.panel.footer')

  @include('admincp.panel.scripts')
  @yield('myscript')

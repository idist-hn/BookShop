                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> +84 1299 632 522</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> minhtoan96.it@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            <li><a href="{{url('')}}" {{$page == 'home' ? 'class=active' : ''}}>Trang Chủ</a></li>
                            <li><a href="{{url('products')}}" {{$page == 'products' ? 'class=active' : ''}}>Nhà Sách E
                                    Shopper</a></li>
                            <li><a href="{{url('blog')}}" {{$page == 'blog' ? 'class=active' : ''}}>Văn Phòng Phẩm</a>
                            </li>
                            <li><a href="{{url('contact-us')}}" {{$page == 'contact_us' ? 'class=active' : ''}}>Liên
                                    Hệ</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="companyinfo">
                        ...
                        <p>Đừng bỏ lỡ hàng ngàn sản phẩm và chương trình siêu hấp dẫn
                        </p>
                    </div>
                </div>
                <div class="col-sm-7">
        ...
        <div class="container">
            <div class="row">
                ...
                <p class="pull-right">Laravel implementation by <span><a target="_blank"
                                                                         href="http://www.tutorials.kode-blog.com">Tutorials Kode Blog</a></span>

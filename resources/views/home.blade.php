                        ...
                        <div class="carousel-inner">
                            @foreach($data['features'] as $feature)
                                <div class="item @if($loop->first) active @endif ">
                                    ...
                                    <div class="col-sm-6">
                                        <img src="{{ $feature->thumbnail }}" class="girl img-responsive" alt="" style="height: 450px"/>
                                    </div>
                                </div>
                            @endforeach
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-9 padding-right">
                    <div class="category-tab"><!--category-tab-->
                        <div class="col-sm-12">
                            <ul class="nav nav-tabs">
                                @foreach($data['categories_feature'] as $category)
                                    <li @if($loop->first) class="active" @endif><a href="#{{ $category->slug }}"
                                            ...
                                            <div class="product-image-wrapper">
                                                <div class="single-products">
                                                    <div class="productinfo text-center">
                                                        <img src="{{ $book->thumbnail }}" alt="" style="height: 184px;"/>
                                                        <h2>{{ $book->price }}</h2>
                                                        <p>{{ $book->name }}</p>
                    ...
                    <div class="recommended_items"><!--recommended_items-->
                        <h2 class="title text-center">Bạn đã xem qua</h2>
